...
$auto = mysqli_query($conn, "select max(surat_keterangan_berdomisili) as max_code from form_surat_keterangan_berdomisili");
...
if (isset($_POST["submit"])) {
    ...
    if (tambah_surat_keteranganberdomisili($_POST) > 0) {
                ...
                <body>
                    ...
                    <form action="" method="post">
                        <table border="0">
                            ...
                            <tr>
                                <td height="50px"> <label for="surat_keterangan_berdomisili">Nomor Surat Keterangan Berdomisili</label>
                                </td>
                                <td> : <input type="text" name="surat_keterangan_berdomisili" id="surat_keterangan_berdomisili" value="<?php echo $no_surat_ket ?>" class="input" autocomplete="off" readonly required> </td>
                            ...
                            <td> <button type="submit" name="submit" class="button-submit" id="submit-inputdata"> Kirim </button>
                                <button type="submit" name="submit" class="button-submit" id="submit-inputdata" style="margin-left: 10px;" onclick="JavaScript:window.location.href='directdownload.php?file=Surat Keterangan Berdomisili.docx';"> Download Surat</button>
