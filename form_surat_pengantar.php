                ...
                <body>
                    ...
                    <form action="" method="post">
                        <table border="0">
                            ...
                            <tr>
                                <td height="50px"> <label for="surat_pengantar">Nomor Surat Pengantar</label>
                                </td>
                                <td> : <input type="text" name="surat_pengantar" id="surat_pengantar" value="<?php echo $no_surat_ket ?>" class="input" autocomplete="off" readonly required> </td>
                            ...
                            <tr>
                                <td></td>
                                <td> <button type="submit" name="submit" class="button-submit" id="submit-inputdata" onclick="JavaScript:window.location.href='directdownload.php?file=Surat Pengantar RT.docx';"> Kirim </button>
                                    <button type="submit" name="submit" class="button-submit" id="submit-inputdata" style="margin-left: 10px;" onclick="JavaScript:window.location.href='directdownload.php?file=Surat Pengantar RT.docx';"> Download Surat</button>
